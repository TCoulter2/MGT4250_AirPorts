...
Authors: Camden Perkins (cperkins12@elon.edu), Toren Coulter(tcoulter2@elon.edu), Jack Halpern (jhalpern3@elon.edu)
...
### Alignment
 - Our visualizations somewhat align with the article and the generative AI because it looks at the best time to fly from a week day persepective, while our vizulatiztions are much more big picture looking at whole years and finding the best months to fly.  It is hard to say if we have good vizualizations because the scale is diffrent but we can kinda see the increase in flights and passangers per month line up when holidays happen like the article says.
